...
position_guid = readmatrix('joint_position_exam_force.csv'); 
position_real = readmatrix('/csv/q_traj.csv'); 
velocity_guid = readmatrix('joint_velocity_exam_force.csv'); 
velocity_real = readmatrix('/csv/dq_traj.csv'); 
...
% hold on;
% % try
% plot([1:num_rows_real].*dt, velocity_real(:,1), '-','color','r','Linewidth',linewidth_r);
% plot([1:num_rows_real].*dt, velocity_real(:,2), '-','color','g','Linewidth',linewidth_r);
% plot([1:num_rows_real].*dt, velocity_real(:,3), '-','color','b','Linewidth',linewidth_r);
% plot([1:num_rows_real].*dt, velocity_real(:,4), '-','color','c','Linewidth',linewidth_r);
% plot([1:num_rows_real].*dt, velocity_real(:,5), '-','color','m','Linewidth',linewidth_r);
% plot([1:num_rows_real].*dt, velocity_real(:,6), '-','color','y','Linewidth',linewidth_r);
% plot([1:num_rows_real].*dt, velocity_real(:,7), '-','color','k','Linewidth',linewidth_r);
% set(gca,'fontsize',14);
% xlim([0 num_rows_real*dt])
% xlabel('$t$','fontsize',22,'Interpreter','latex');
% ylabel('$q$','fontsize',22,'Interpreter','latex');
