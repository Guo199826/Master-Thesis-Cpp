...
int main(void)
{
    ...
    // Trajectory from guidance /////////////////////////////////////////////////////////////////////
    // matrix that holds the data from csv
    ...
    q_1 << -0.000545241, -0.787773, -0.00212514, -2.3583, 0.01, 1.57543, 0.795024;
    VectorXd q_goal(n);
    Vector3d x_t_goal;
    ...
    MatrixXd qt_track(7,t_all);
    MatrixXd dq_track(7,t_all);
    MatrixXd x_t_track(3,t_all);
    MatrixXd J;
    MatrixXd J_geom;
    MatrixXd J_geom_t;
    MatrixXd J_geom_t_axis;
    MatrixXd Me_ct(m,m);
    Tensor<double, 3> Me_track(m,m,t_all);
